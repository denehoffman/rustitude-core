...
fn main() {
    ...
    let f0 = gluex::FrozenKMatrix::new(
        ...
        array![0.51461, 0.90630, 1.23089, 1.46104, 1.69611],
        array![
        ...
        array![0.13498, 0.26995, 0.49368, 0.54786, 0.54786],
        array![0.13498, 0.26995, 0.49761, 0.54786, 0.95778],
        0,
        particles.clone(),
    ...
    let f2 = gluex::FrozenKMatrix::new(
        ...
        array![1.15299, 1.48359, 1.72923, 1.96700],
        array![
        ...
        array![0.13498, 0.26995, 0.49368, 0.54786],
        array![0.13498, 0.26995, 0.49761, 0.54786],
        2,
        particles.clone(),
        None,
    )
    ...
    let a0 = gluex::FrozenKMatrix::new(
        "a0",
        1,
        array![[0.43215, 0.19], [-0.28825, 0.43372]],
        array![0.95395, 1.26767],
        array![[0.00000, 0.00000], [0.00000, 0.00000],],
        array![0.13498, 0.49368],
        array![0.54786, 0.49761],
        0,
        particles.clone(),
        None,
    )
    ...
    let a2 = gluex::FrozenKMatrix::new(
        "a2",
        0,
        array![[0.30073, 0.68567], [0.21426, 0.12543], [-0.09162, 0.00184]],
        array![1.30080, 1.75351],
        array![
            [-0.40184, 0.00033, -0.08707],
            [0.00033, -0.21416, -0.06193],
            [-0.08707, -0.06193, -0.17435],
        ],
        array![0.13498, 0.49368, 0.13498],
        array![0.54786, 0.49761, 0.95778],
        2,
        particles.clone(),
        None,
    )
